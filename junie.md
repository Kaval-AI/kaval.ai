...
- `kavalai/`: Main Python package.
    ...
    - `normalizer.py`: Embedding transformation utilities including L1/L2 normalization and centering. Supports learning centering parameters from RAG index, YAML saving/loading, and numpy-optimized batch operations.
