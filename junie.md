...
- `scripts/`: Utility scripts.
    - `migrate_db.py`: Database migration tool. It tracks applied migrations in `kavalai_migrations` table with checksum verification and applies them in a single transaction.
